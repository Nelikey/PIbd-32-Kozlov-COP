...
{
    public partial class TableWordFirst2Rows : Component
    {
        public TableWordFirst2Rows()
        {
            InitializeComponent();
        }

        public TableWordFirst2Rows(IContainer container)
        {
            container.Add(this);
        ...
        public void ParametersInput<T>(string fileName, string title, List<WordTitleColumn> titleColumns,
            List<WordMergedTitleColumn> mergedTitleColumns, List<T> data)
        {
        ...
        // Создание документа
        private void CreateDoc<T>(string FileName, string Title, List<WordTitleColumn> titleColumns,
            List<WordMergedTitleColumn> mergedTitleColumns, List<T> data)
        {
            using (WordprocessingDocument wordDocument = WordprocessingDocument.Create(FileName, WordprocessingDocumentType.Document))
            {
                ...
                {
                    Texts = new List<(string, WordTextProperties)> { (Title, new WordTextProperties {Bold = true, Size = "28", } ) },
        ...
        private ParagraphProperties CreateParagraphProperties(WordTextProperties
       paragraphProperties)
        {
